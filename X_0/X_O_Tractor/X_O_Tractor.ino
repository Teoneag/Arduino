...
void mutare0() {
  ...
  while (ok == 0) {
    ...
    else if (tabla[4] == 'X' && tabla[0] == '-') {
      tabla[0] = '0';
      Serial.print("Arduino a ales pozitia: ");
      Serial.print(1, DEC);
      Serial.println();
      ok = 1;
    } else if (tabla[0] == 'X' && tabla[4] == '-' || tabla[2] == 'X' && tabla[4] == '-' || tabla[8] == 'X' && tabla[4] == '-' || tabla[6] == 'X' && tabla[4] == '-' || tabla[1] == 'X' && tabla[4] == '-' || tabla[3] == 'X' && tabla[4] == '-' || tabla[5] == 'X' && tabla[4] == '-' || tabla[7] == 'X' && tabla[4] == '-') {
      tabla[4] = '0';
      Serial.print("Arduino a ales pozitia: ");
      Serial.print(5, DEC);
      Serial.println();
      ok = 1;
    } else if (tabla[1] == 'X' && smecherie - 6 >= 0 && tabla[smecherie - 6] == '-') {
      tabla[smecherie - 6] = '0';
      Serial.print("Arduino a ales pozitia: ");
      Serial.print(smecherie - 5);
      Serial.println();
      ok = 1;
    } else if (tabla[3] == 'X' && smecherie - 2 >= 0 && tabla[smecherie - 2] == '-') {
      tabla[smecherie - 2] = '0';
      Serial.print("Arduino a ales pozitia: ");
      Serial.print(smecherie - 1);
      Serial.println();
      ok = 1;
    } else if (tabla[5] == 'X' && tabla[smecherie + 2] == '-') {
      tabla[smecherie + 2] = '0';
      Serial.print("Arduino a ales pozitia: ");
      Serial.print(smecherie + 3);
      Serial.println();
      ok = 1;
    } else if (tabla[7] == 'X' && tabla[smecherie + 6] == '-') {
      tabla[smecherie + 6] = '0';
      Serial.print("Arduino a ales pozitia: ");
